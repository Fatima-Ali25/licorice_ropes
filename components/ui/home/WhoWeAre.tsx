  ...
  return (
    <section className="py-16 sm:py-12 md:py-16 lg:py-20 xl:py-24 bg-white">
      <div className="layout flex flex-col w-full h-full gap-6">
        {/* Header Section */}
        <div className=" flex md:flex-row flex-col gap-4 mb-10 sm:mb-8 md:mb-20 w-full justify-between">
        ...
        {/* Title */}
        <h1 className="w-full h-full uppercase text-4xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl font-bold sm:mb-10 md:mb-12 lg:mb-20">
