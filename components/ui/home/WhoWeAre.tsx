            ...
            <div className="layout">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-12">
                    <div className="flex items-center gap-4 mb-4 lg:mb-0">
                        <span className="text-black text-sm font-medium underline">About Us</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-sm font-medium text-black underline lg:justify-end">
                ...
                {/* Main Content Grid */}
                <div className="flex gap-8 lg:gap-10 w-full h-full">
                    {/* Left Side - Image and Button */}
                    <div className=" flex flex-col items-start justify-center gap-10 h-full w-1/2">
                        <Image
                            width={436}
                            height={436}
                            src="/images/team.png"
                        ...
                        <Button
                            className="bg-[#FBC332] w-[143px] h-[36px] hover:bg-white text-black py-4 text-lg font-semibold rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl"
                        >
                            View More
                        </Button>
                    </div>
                    ...
                    {/* Statistics */}
                    <div className=" flex flex-col justify-center gap-10 h-full w-1/2">
                        <div className="flex items-center gap-4">
                            <span className="text-3xl md:text-4xl font-bold text-[#E85A2D]">10+</span>
                            <span className="text-black font-medium">Years</span>
                            <p className="text-gray-600 text-sm mt-1">Lorem Ipsum Dolor</p>
                        </div>

                        <div className="flex items-center gap-4">
                            <span className="text-3xl md:text-4xl font-bold text-[#E85A2D]">29,000+</span>
                        ...
                        <div className="flex items-center gap-4">
                            <span className="text-3xl md:text-4xl font-bold text-[#E85A2D]">450+</span>
                    ...
                    <div className=" flex flex-col justify-center gap-7 bg-amber-300 h-full w-1/2">
                        ...
                        <Image
                            ...
                            className="w-[400px] h-[400px] md:h-56 object-cover rounded-2xl shadow-lg"
                        />
