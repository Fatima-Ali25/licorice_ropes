        ...
        <section className="py-16 sm:py-12 md:py-16 lg:py-20 xl:py-24 bg-white">
            <div className="layout flex flex-col">
                ...
                <div className="flex flex-col lg:flex-row gap-6 w-full h-full">
                    ...
                    <div className="flex flex-col items-center lg:items-start gap-8 p-2 sm:gap-6 md:gap-8 lg:gap-10 lg:w-1/2">
                    ...
                    {/* Statistics */}
                       <div className="flex flex-col h-full w-1/2 justify-center gap-20 p-2">
                      <div className="flex flex-col h-1/2 justify-center gap-4 sm:gap-1 md:gap-1 lg:gap-10 w-full ">

                        <div className="flex flex-col  sm:gap-1 w-full">    
                            <h1 className="text-4xl sm:text-2xl md:text-4xl font-bold text-[#E85A2D]">10+ <span className="text-black font-medium text-2xl sm:text-2xl">Years</span> </h1>
                            <p className="text-black text-2xl ">Lorem Ipsum Dolor</p>
                        </div>
                        <div className="flex flex-col sm:gap-1 w-full">
                            <h1 className="text-4xl sm:text-4xl md:text-4xl font-bold text-[#E85A2D]">29,000+ </h1>
                            <p className="text-black text-2xl ">Lorem Ipsum Dolor Sit Amet</p>
                        </div>

                        <div className="flex flex-col sm:gap-1 w-full">
                            <h1 className="text-4xl sm:text-4xl md:text-4xl font-bold text-[#E85A2D]">450+ </h1>
                            <p className="text-black text-2xl">Lorem Ipsum Dolor Sit</p>
                        </div>

                      </div>
                        <p className="text-black font-inter leading-relaxed text-sm font-inter sm:text-sm md:text-lg  ">
                    ...
                    <div className="flex flex-col justify-center gap-4 sm:gap-6 md:gap-7 p-2 sm:p-6 md:p-8 w-full lg:w-1/2 h-full">

                        {/* Company Description */}
                        <p className="text-black leading-relaxed text-sm font-inter sm:text-sm md:text-lg ">
